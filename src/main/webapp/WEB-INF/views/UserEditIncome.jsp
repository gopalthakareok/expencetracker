  	...
  	<main id="main" class="main">
    	...
    	<section class="section dashboard" style="min-height: 467px;">
            ...
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3 mt-2" action="userupdateincome" method="post">
                <div class="col-10">
                  <label for="title" class="form-label">Title</label>
                  <input type="text" class="form-control" name="title" id="title" value="${income.title}">
                </div>
                <div class="col-10">
                  <label for="amount" class="form-label">Amount</label>
                  <input type="text" class="form-control" name="amount" id="amount" value="${income.amount}">
                </div>
                <div class="col-md-10">
                ...
                <div class="col-10">
                  ...
                  <input type="date" class="form-control" name="transactionDate" id="transactionDate" value="${income.transactionDate}">
                </div>
                <div class="col-10">
                  <label for="description" class="form-label">Description</label>
                  <input type="text" class="form-control" name="description" id="description" value="${income.description}">
                </div>
