...
<head>
	...
	<meta content="width=device-width, initial-scale=1.0" name="viewport">
  	...
  	<title>Edit Account | Expense Tracker</title>
  	...
  	<main id="main" class="main">
    	...
    	<section class="section dashboard" style="min-height: 467px;">
            ...
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3 mt-2" action="userupdateaccount" method="post">
                <div class="col-10">
                ...
                <div class="col-10">
                  ...
                  <input type="text" class="form-control" name="amount" id="amount" value="${account.amount}">
                </div>
                <div class="col-10">
