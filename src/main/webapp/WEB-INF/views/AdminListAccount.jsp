...
<title>Account | List Accounts</title>
										...
										<tbody>
											<c:forEach items="${accountList}" var="a">
												<tr>
													...
													<td>${a.description }</td>
													<td>${a.userId}</td>
													<td><a href="adminviewaccount?accountId=${a.accountId}">View</a> | <a href="admindeleteaccount?accountId=${a.accountId}">Delete</a> | Edit </td>
