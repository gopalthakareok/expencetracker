  	...
  	<main id="main" class="main">
    	...
    	<section class="section dashboard" style="min-height: 467px;">
            ...
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3 mt-2" action="userupdatesubcategory" method="post">
                <div class="col-10">
                  <label for="subcategoryName" class="form-label">SubCategory</label>
                  <input type="text" class="form-control" name="subCategoryName" id="title" value="${subcategory.subCategoryName}">
                </div>
                <div class="col-md-10">
