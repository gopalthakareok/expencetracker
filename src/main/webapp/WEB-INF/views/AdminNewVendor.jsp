...
<head>
	...
	<meta content="width=device-width, initial-scale=1.0" name="viewport">
  	...
  	<title>Vendors | Expense Tracker</title>
  	...
  	<main id="main" class="main">
    	...
    	<section class="section dashboard" style="min-height: 467px;">
            ...
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3 mt-2" action="adminsavevendor" method="post">
                <div class="col-10">
                  <label for="vendorName" class="form-label">Vendor Name</label>
                  <input type="text" class="form-control" name="vendorName" id="title">
                </div>
                <div class="col-md-10">
