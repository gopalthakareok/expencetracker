									...
									<table class="table datatable datatable-table table-hover" id="myTable">
										...
										<tbody>
											<c:forEach items="${vendorList}" var="v">
												<tr>
													<td>${v.vendorName}</td>	
													<td><a href="viewvendor?vendorId=${v.vendorId}">View</a> | <a href="userdeletevendor?vendorId=${v.vendorId}">Delete</a> | <a href="usereditvendor?vendorId=${v.vendorId}">Edit</a> </td>
